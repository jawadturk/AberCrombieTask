package com.example.abercrombietask.stickyrecyclerheaders;
...
//                        int i = 0;
                        ...
                        Collection<Section> values = sections.values();
                        for (Section iteratingSection : values) {
////                            if (i >= position) break;
////                            headerPosition -= iteratingSection.getContentItemsTotal();
////                            if (!iteratingSection.hasHeader()) {
////                                headerPosition--;
////                            }
//                            Log.d("TAG", "onBindViewHolder: headerPosition= " + headerPosition
//                                    + " position: " + position);
//                            i++;
                        }

                        // delegate the binding to the section header
                        getSectionForPosition(position).onBindHeaderViewHolder(holder, headerPosition);
                        return;
                    }
                }
